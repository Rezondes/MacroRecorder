...
Branding: in-app vector in `MacroRecorder.Wpf/Branding/AppBrandMark.cs`; EXE/taskbar/README: `MacroRecorder.App/Assets/app-icon.ico` (generated by `build-app-icon.ps1`).
