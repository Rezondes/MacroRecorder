...
- **Aktueller Status:** Version `0.0.8` in csproj; Release via Tag `v0.0.8` + GitHub Actions (portable ZIP). In-App-Update: Check + **Jetzt aktualisieren** via stabiler `MacroRecorderByRezondes.Updater.exe`.
